...
public class ExternalApproveService {
    ...
    public int approve(CollateralObject object) {
        if (object.getAssessedDate() == null ||object.getYear() == null || object.getAssessedValue() == null || object.getType() == null) {
            return -1;
        }
    ...
    private int approveCar(CollateralObject object) {
        ...
        if (object.getAssessedDate().isBefore(MIN_ASSESS_DATE)) {
            return -11;
        }
        if (object.getAssessedValue().compareTo(MIN_CAR_VALUE) < 0) {
            return -12;
        }
    ...
    private int approvePlane(CollateralObject object) {
        ...
        if (object.getAssessedValue().compareTo(MIN_PLANE_VALUE) < 0) {
            return -22;
        }
